...
```{r echo =FALSE}
# Libraries----
pacman::p_load(modules, rio, tidyverse, stm, tidytext, ggwordcloud, sjPlot, DescTools, ggpage, quanteda, patchwork)
...
tidy_gamma %>% 
  ...
  labs(title = "Proportion of frame by document category",
       fill = "Frames",
       y = NULL,
       x = "Proportion")
```
...
(res$wordcloUd_graph | (res$pie_graph / res$page_graph)) +
  plot_annotation(title = str_c("Frames distribution in the document '",
                                res$param[[2]], "'"),
